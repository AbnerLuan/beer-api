...
import static com.luan.beerstock.utils.JsonConvertionUtils.asJsonString;
...
import com.luan.beerstock.builder.BeerDTOBuilder;
...
import com.luan.beerstock.service.BeerService;
...
public class BeerControllerTest {
    ...
    void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerWithInsufficientStockException.class);
